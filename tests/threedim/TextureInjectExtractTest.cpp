...
// by a version sentinel), never `!m_cached_out` (the TagAs re-dirty class;
// contrast Transform3D, whose null-input ticks publish
...
// Camera::release m_state handling (tests/threedim/CameraRelease.cpp): after
