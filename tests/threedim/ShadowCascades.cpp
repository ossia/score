// Threedim::ShadowCascadeSetup — the reworked pure QMatrix4x4 cascade math
// (findActiveCamera, the reverse-Z NDC flip, and the corrected zPad direction).
//
          ...
          "[threedim][shadow]")
{
  ...
  // padding minLS instead (the pre-rework direction) would only add room
