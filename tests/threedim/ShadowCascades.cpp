// Threedim::ShadowCascadeSetup — the pure QMatrix4x4 cascade math
// (findActiveCamera, the reverse-Z NDC flip, and the zPad direction).
//
          ...
          "[threedim][shadow]")
{
  ...
  // padding minLS instead would only add room beyond the slice, where nothing
  // can cast into it.
