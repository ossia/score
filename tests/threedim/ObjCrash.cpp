...
// gracefully (empty or clamped) WITHOUT crashing: unguarded, each of these
// inputs segfaults the test process.
    ...
    "[threedim][obj][f1]")
{
  ...
  // 99999999), i.e. attrib.vertices[3*99999999] if unchecked.
    ...
    "[threedim][obj][f1]")
{
  ...
  // face is position-only so texcoord_index stays -1, i.e.
  // attrib.texcoords[2*size_t(-1)] if unchecked.
  static constexpr std::string_view obj = R"(v 0 0 0
v 1 0 0
v 0 1 0
vt 0 0
    ...
    "[threedim][obj][f1]")
{
  ...
  // normals so normal_index stays -1, i.e. attrib.normals[3*size_t(-1)].
  static constexpr std::string_view obj = R"(v 0 0 0
v 1 0 0
v 0 1 0
vn 0 0 1
    ...
    "[threedim][obj][f1]")
{
  ...
  // positive), indexing attrib.texcoords / attrib.normals far past the end.
  static constexpr std::string_view obj = R"(v 0 0 0
v 1 0 0
v 0 1 0
vt 0 0
