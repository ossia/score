...
// against an SRB whose layout is uniform@0 / src@1 / out@2, and its update() --
// invoked every frame by ExtractBuffer2 -- must rebind on those same indices.
//
    ...
    "[threedim][extract][f13]")
{
  ...
  score::test::run_in_gui_app([&](const score::GUIApplicationContext&) {
    ...
    // Frame-2 rebind: update() reconstructs m_srb, and must reuse the
    // uniform@0 / src@1 / out@2 layout the pipeline was built against.
