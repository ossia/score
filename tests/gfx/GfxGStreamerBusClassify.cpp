...
//
// What follows is therefore a MODEL, clearly labelled: the decision table over
// m_started / m_feeding and the gating of poll, stop and push, for both the pre-
// and post-fix logic. It encodes the contract as an executable, deterministic
// proof; it cannot flip RED against a reverted engine, since that code is
