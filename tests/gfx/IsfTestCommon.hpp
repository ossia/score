...
//
// Test-only conveniences layered on top of the render+readback fixture in
// tests/fixtures/score_test/Gfx.hpp, which this leaves untouched. They factor
// out the two things every ISF test file needs:
//
...
//                             assert the readbacks agree across backends.
//
