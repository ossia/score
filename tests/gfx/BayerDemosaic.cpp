// =============================================================================
// L3 -- what the GPU Bayer demosaic actually puts on screen.
//
// tests/unit/WireDecoderFactoryTest.cpp proves each CFA format resolves to A
// decoder; nothing there asserts what that decoder reconstructs. The demosaic's
// two parameters are its two failure modes:
//
