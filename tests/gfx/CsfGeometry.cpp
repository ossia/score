...
// sink.
//
// Each geometry/storage CSF must parse, construct a score::gfx::ISFNode via the
// compute constructor, and expose the expected Geometry / Buffer output port(s).
// The RENDER readback is SKIPped with the precise reason. (make_csf_node parses
// with no GPU, so these run even headless.)
// =============================================================================
