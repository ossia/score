...
// whole GfxContext/app is torn down -- a subsequent in-process render that
// rebuilds pipelines (a sink resize) then dereferences the stale handle and
// SIGSEGVs. That interaction is captured and documented in
...
// the resize/reconnect cases in test_gfx_incremental -- the same isolation
// convention as test_gfx_isf_mrt_persistent / test_gfx_csf_image3d.
//
