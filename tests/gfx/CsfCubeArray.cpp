...
//
// REGRESSION GUARD. The quadrant sampling a face/layer past 0 (BR = +Z face /
// layer 3) must be non-black on BOTH backends. The +X-face / layer-0 quadrant
// (TL) is written on either path and is a sanity anchor. GREEN on OpenGL and
// Vulkan. Do NOT weaken.
//
