...
// top-down elsewhere. GfxOrientationFindings.cpp documents that defect and the
// two one-line fixes that do not work, the second of which fails because
// correcting only the store turns a generator green and a relay red.
//
