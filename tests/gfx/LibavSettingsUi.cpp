// Gfx/Libav/LibavSettingsWidget.cpp and Gfx/Libav/LibavPresets.cpp: the FFmpeg
// input/output device's settings UI and the preset enumerators the device list
// offers.
//
