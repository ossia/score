// =============================================================================
// L3 ISF CONTROL-VALUE injection: the float / color / point2D / point3D /
// bool / long control-inlet families.
//
...
//
// This is the mechanism that covers the control-value half of the
// isf-all-input-types SKIP in IsfUnsupported.cpp.
//
