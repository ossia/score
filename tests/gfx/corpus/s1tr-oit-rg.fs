/*{
  "DESCRIPTION": "S1 LAYER fixture: two full-screen quads drawn back to front, premultiplied: red alpha 0.5 at window depth 0.3, then green alpha 0.6 at 0.6. Weighted blended order-independent transparency (McGuire & Bavoil 2013), weight 1 + 9 * nearness.",
  "ISFVSN": "2.0",
