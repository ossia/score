/*{
  "DESCRIPTION": "Writes 1.0 into attribute foo declared with SEMANTIC foo. Paired with fixc-attr-foo-consumer.cs.",
  "CREDIT": "test",
  "ISFVSN": "2.0",
  "MODE": "COMPUTE_SHADER",
  "RESOURCES": [
    { "NAME": "geo", "TYPE": "geometry", "VERTEX_COUNT": "4",
      "ATTRIBUTES": [ { "NAME": "foo", "SEMANTIC": "foo", "TYPE": "float", "ACCESS": "write_only" } ] }
  ],
