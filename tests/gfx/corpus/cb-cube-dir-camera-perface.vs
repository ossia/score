// Camera-driven cube capture, vertex stage. Pairs with cb-cube-dir-camera-perface.fs.
//
...
// camera[PASSINDEX]'s viewProjection: every fragment sees the world
