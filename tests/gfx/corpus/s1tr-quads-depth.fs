/*{
  "DESCRIPTION": "S1 LAYER fixture: two full-screen quads drawn back to front, premultiplied: red alpha 0.5 at window depth 0.3, then green alpha 0.6 at 0.6. Colour and alpha-weighted depth targets; the resolve writes the expected depth where the alpha reaches the threshold input (0.5).",
  "ISFVSN": "2.0",
  ...
  "INPUTS": [ { "NAME": "threshold", "TYPE": "float", "DEFAULT": 0.5 } ],
  "LAYER": {
