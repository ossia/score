...
void main()
{
    ...
    // 64^3 -> R=64, 32^3 -> R=32, 96^3 -> R=96. The dispatch is sized from the
    // actual texture, so R always tells which allocation the writer really
    // covered -- the size fingerprint.
