/*{
  "DESCRIPTION": "NDC-derived MULTIVIEW:6 cube capture: every texel of face f stores the direction the GL cube-map face table (4.6, Table 8.19) assigns to it, computed from the pre-clipSpaceCorrMatrix NDC position (v_uv) with row 0 of the face at v_uv.y = 0, rgb = dir * 0.5 + 0.5. The cubeFaceDir of the csf-examples IBL presets.",
  "CREDIT": "test",
  "ISFVSN": "2.0",
