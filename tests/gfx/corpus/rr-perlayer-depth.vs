...
// exactly as corpus/rr-perlayer.vs does, so this shader
...
// iteration index the runtime stamps into ProcessUBO::passIndex
// (RenderedRawRasterPipelineNode), which for EXECUTION_MODEL PER_LAYER is the
// array layer index 0..LAYERS-1; the same field shadow_cascades.vert uses as
// its cascade index. It is #defined onto the process UBO in
