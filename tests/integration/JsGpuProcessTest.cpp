...
//
// JS::ProcessModel::isGpu() decides which executor the process gets purely by
// looking for a TextureInlet or a TextureOutlet among the children of the
// parsed script; JS::Executor::Component then builds either
...
// Device context properties it sets on its own engine, and reading a rendered
// texture back by value. Those need a live render list and a real RHI backend.
//
