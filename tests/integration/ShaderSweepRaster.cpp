...
// already uses for the hand-picked cases. Sweeping them as ISF instead, on the
// grounds that they are also .fs files, only bakes "'position' : undeclared
// identifier" for every one of them and never executes
