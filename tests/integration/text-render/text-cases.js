...
// that the DEFAULT controls ("Greetings from Oscar !", Monospace 28pt, white,
// scale 1) produce VISIBLE text at the default position.
//
...
var CASES = {
  ...
  // which pins that an untouched Text process renders on screen. The Position
  // XYSlider is built with the plain ControlInlet ctor in Gfx/Text/Process.cpp,
  // so no init value is pushed and the rendered position is whatever
  // Gfx::Text::Node's UBO defaults to.
