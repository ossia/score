...
//! feedback-texture.fs prescribes. The Score scripting API exposes no delayed
//! feedback cable, so the graph fixture is the only place this shape can be
//! built.
...
void runWired(const score::GUIApplicationContext& ctx)
{
  ...
  // Ordered last: isf-multipass-uniform-input
