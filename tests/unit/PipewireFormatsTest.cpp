...
// and the interop vocabulary must not be able to disagree. Each table is
// self-consistent on its own, so exporting RGB10A2 as 'AB30' -- the mirrored
// layout of the 'AR30' it negotiates -- shows up nowhere else.
