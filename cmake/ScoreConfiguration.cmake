...
option(OSSIA_USE_SYSTEM_LIBRARIES "Try to use system libraries as far as possible" OFF)
if(SCORE_USE_SYSTEM_LIBRARIES)
  set(OSSIA_USE_SYSTEM_LIBRARIES ON CACHE BOOL "" FORCE)
endif()

function(score_use_system out pkg)
