...
set(SCORE_EXPECTED_RED
  ...
  "shouldfail@tests/gfx/GfxReviewGraphLifecycle.cpp@GraphLifecycle-2 unreachable input render targets are reclaimed@G2: incremental node removal keeps centralized input render targets alive. Its correction runs through the public API only, so the leak is in reconciliation and not in the test"
  "shouldfail@tests/gfx/GfxReviewGraphLifecycle.cpp@GraphLifecycle-3 rebuild commits persistent registry initialization@G3: a rebuild before the first frame discards the registry initialization uploads. Correction restores them through the public API"
  "shouldfail@tests/gfx/GfxReviewGraphLifecycle.cpp@GraphLifecycle-4 incremental input target honors mip allocation@G4: incrementally allocated input targets omit the mip flags the spec asks for"
