...
set(SCORE_EXPECTED_RED
  ...
  "shouldfail@tests/gfx/GfxRawRasterModelMatrixBinding.cpp@MODEL_MATRIX reads identity with and without MULTIVIEW@isf.cpp reserves a binding slot for the multiview UBO when MULTIVIEW >= 2 and bumps model_ubo_binding past it, while RenderedRawRasterPipelineNode numbers its own bindings from `int max_binding = 3` plus samplers plus aux textures and reserves nothing -- it has no multiview UBO at all, unlike RenderedISFNode and SimpleRenderedISFNode. Measured on Vulkan: the non-multiview control reads 127,127,255 and every one of the six multiview faces reads 0,0,255, i.e. the blue draw-witness proves the face rendered and the matrix still arrives zeroed. Goes green when the renderer reserves the same slot the parser does"
