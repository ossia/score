...
function(enable_minimal_qt_plugins theTarget gui)
  ...
  if(SCORE_CUSTOM_QT_PLUGINS)
    foreach(plugin ${SCORE_CUSTOM_QT_PLUGINS})
      link_if_exists(${plugin})
    endforeach()
  else()
  ...
  if(${gui})
    link_if_exists(Qt6::QComposePlatformInputContextPlugin)
    ...
    if(NOT SCORE_QT_PLUGINS_NO_IMAGEFORMATS)
...
#    link_if_exists(Qt6::QSCNetworkReachabilityNetworkInformationPlugin)
    ...
    link_if_exists(Qt6::canvas2dplugin)
    ...
    if(NOT SCORE_QT_PLUGINS_NO_QTQUICK3D)
      ...
      link_if_exists(Qt6::QmlAssetDownloaderplugin)
      link_if_exists(Qt6::AssimpImporterPlugin)
    endif()
  endif()
  endif()
endfunction()
