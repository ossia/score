...
case "$TRAVIS_OS_NAME" in
  linux)
    ...
    sudo apt-get install -qq --force-yes g++-6 binutils libasound-dev ninja-build gcovr lcov qt59-meta-minimal qt59svg qt59quickcontrols2 qt59websockets clang-4.0
