...
export QT_SDK=/home/jcelerier/Qt/5.4
export ANDROID_NDK=/opt/android-ndk
export ANDROID_SDK=/opt/android-sdk
export PATH=$ANDROID_SDK/tools:$ANDROID_SDK/platform-tools:$ANDROID_SDK/build-tools/android-4.4W:$PATH

cmake -DCMAKE_TOOLCHAIN_FILE=$BASE_DIR/CMake/Android/android.toolchain.cmake -DCMAKE_PREFIX_PATH=$QT_SDK/android_armv7/lib/cmake/ ../i-score
make -j8
make apk_debug
