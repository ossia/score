    ...
    : QWidget(parent)
{
  ...
  { // Create new
    ...
    connect(label, &score::InteractiveLabel::labelPressed, this, &score::StartScreen::openNewDocument);
  ...
  { // Load file
    ...
    connect(label, &score::InteractiveLabel::labelPressed, this, &score::StartScreen::openFileDialog);
    label->move(100,label_y);
    label_y += 35;
  }
  { // Load Examples
    ...
    InteractiveLabel* label = new InteractiveLabel{titleFont, qApp->tr("Examples"), "file://" + library_path, this};
  ...
  }
  {
    ...
    auto m_getLastVersion = new HTTPGet{
        ...
        [=] (const QByteArray& data) {
          ...
          {
            QString text = qApp->tr("New version %1 is available, click to update !").arg(version);
  ...
  for(const auto& action: recentFiles->actions())
  {
    ...
    connect(fileLabel, &score::InteractiveLabel::labelPressed, this, &score::StartScreen::openFile);
  ...
  m_crashLabel->hide();
  connect(m_crashLabel, &score::InteractiveLabel::labelPressed, this, &score::StartScreen::loadCrashedSession);
}
