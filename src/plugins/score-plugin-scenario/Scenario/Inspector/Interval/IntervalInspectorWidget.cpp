    ...
    , m_model{object}
{
  ...
  }
  {
    ...
    score::setHelp(
        interp, tr("Interpolate states (Ctrl+K)"),
  ...
  // Quantization
  {
    ...
    score::setHelp(quantiz, tr("Set quantification to synchronize the interval start"));
