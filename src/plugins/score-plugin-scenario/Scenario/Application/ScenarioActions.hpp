...
SCORE_DECLARE_ACTION(
    ...
    "&Reinitialize",
    Scenario,
    QKeySequence(QObject::tr("Ctrl+Return")))
...
SCORE_DECLARE_ACTION(
    ...
    "&Disable Trigger",
    Scenario,
    QKeySequence(QObject::tr("Shift+T")))
...
SCORE_DECLARE_ACTION(
    ...
    "&Synchronize",
    Scenario,
    QKeySequence(QObject::tr("Shift+M")))
SCORE_DECLARE_ACTION(
    ShowRacks,
    "&Show processes",
    Scenario,
...
SCORE_DECLARE_ACTION(
    ...
    "&Encapsulate",
    Scenario,
    QKeySequence(QObject::tr("Ctrl+Alt+E")))
SCORE_DECLARE_ACTION(
    Decapsulate,
    "&Decapsulate",
    Scenario,
    QKeySequence(QObject::tr("Ctrl+Alt+D")))
SCORE_DECLARE_ACTION(
    FoldIntervals,
    "Fold intervals",
    Scenario,
    QKeySequence(QObject::tr("Ctrl+Alt+F")))
SCORE_DECLARE_ACTION(
    UnfoldIntervals,
    "Unfold intervals",
    Scenario,
...
SCORE_DECLARE_ACTION(
    ...
    Scenario,
    QKeySequence(QObject::tr("Ctrl+Alt+Up")))

SCORE_DECLARE_ACTION(
    Duplicate,
    "&Duplicate",
    Scenario,
    QKeySequence(QObject::tr("Alt+D")))
...
SCORE_DECLARE_ACTION(
    ...
    "&Go to parent",
    Scenario,
    QKeySequence(QObject::tr("Ctrl+Up")))

/// Context menus
SCORE_PROCESS_DECLARE_CONTEXT_MENU(
    SCORE_PLUGIN_SCENARIO_EXPORT,
    ScenarioObjectContextMenu)
SCORE_PROCESS_DECLARE_CONTEXT_MENU(
    SCORE_PLUGIN_SCENARIO_EXPORT,
    ScenarioModelContextMenu)
SCORE_PROCESS_DECLARE_CONTEXT_MENU(
    SCORE_PLUGIN_SCENARIO_EXPORT,
    IntervalContextMenu)
SCORE_PROCESS_DECLARE_CONTEXT_MENU(
