...
public:
  ...
  ChangeElementColor(const T& obj, score::ColorRef newColor) : m_path{obj}, m_newColor{newColor}
  {
...
protected:
  ...
  void deserializeImpl(DataStreamOutput& s) override { s >> m_path >> m_oldColor >> m_newColor; }
