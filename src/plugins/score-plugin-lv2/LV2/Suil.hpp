...
private:
      ...
      :library("libsuil-0.so.0")
  {
    ...
    host_set_touch_func = library.symbol<decltype(&::suil_host_set_touch_func)>("suil_host_set_touch_func");
    ...
    instance_free = library.symbol<decltype(&::suil_instance_free)>("suil_instance_free");
    instance_get_handle = library.symbol<decltype(&::suil_instance_get_handle)>("suil_instance_get_handle");
    instance_get_widget = library.symbol<decltype(&::suil_instance_get_widget)>("suil_instance_get_widget");
    instance_port_event = library.symbol<decltype(&::suil_instance_port_event)>("suil_instance_port_event");
    instance_extension_data = library.symbol<decltype(&::suil_instance_extension_data)>("suil_instance_extension_data");
