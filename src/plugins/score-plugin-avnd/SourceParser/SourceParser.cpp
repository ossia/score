...
std::string list_inputs(std::string file, std::span<char*> orig_argv)
{
  ...
  if(orig_argv.empty())
  {
    std::vector<const char*> argv_default{
        ...
        "-I" LAFAJOL_SOURCE_DIR "/3rdparty/libossia/3rdparty/flat",
        "-I" LAFAJOL_SOURCE_DIR "/3rdparty/libossia/3rdparty/fmt/include",
        "-I" LAFAJOL_SOURCE_DIR "/3rdparty/libossia/3rdparty/flat_hash_map",
        "-I" LAFAJOL_SOURCE_DIR "/3rdparty/libossia/3rdparty/hopscotch-map/include",
