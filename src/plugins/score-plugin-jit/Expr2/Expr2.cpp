...
{
  // AudioOutlet gained a leading name argument; "Audio Out" is what the other
  // JIT processes use (AvndJit, Faust).
  auto audio_out
      = new Process::AudioOutlet{"Audio Out", Id<Process::Port>{0}, this};
