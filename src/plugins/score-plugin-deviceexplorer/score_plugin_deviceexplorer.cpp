...
score_plugin_deviceexplorer::score_plugin_deviceexplorer()
{
  ...
  ossia::for_each_in_tuple(
      std::tuple<
          ossia::net::instance_bounds_attribute, ossia::net::tags_attribute,
          ossia::net::description_attribute, ossia::net::refresh_rate_attribute,
          ossia::net::priority_attribute, ossia::net::value_step_size_attribute,
...
score::GUIApplicationPlugin* score_plugin_deviceexplorer::make_guiApplicationPlugin(
