...
get_nodes(const std::vector<std::pair<
              ...
              AudioChainComponentBase::RegisteredEffect>>& fx)
{
                                     ...
                                     parent}
{
  ...
  element.effects()
      .orderChanged.connect<&AudioChainComponentBase::on_orderChanged>(
          *this);
}
...
AudioChainComponentBase::~AudioChainComponentBase()
{
  process()
      .effects()
      .orderChanged.disconnect<&AudioChainComponentBase::on_orderChanged>(
          *this);
}
...
std::function<void()> AudioChainComponentBase::removing(
...
void AudioChainComponentBase::unreg(
    const AudioChainComponentBase::RegisteredEffect& fx)
{
    ...
    false>{score::lazy_init_t{}, element, ctx, id, parent}
{
  ...
  connect(
        &element,
        &Media::AudioChain::ProcessModel::badChainingChanged,
        this,
        [&](bool b) {
    if (b)
    {
