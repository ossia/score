...
W_OBJECT_IMPL(Process::FloatSlider)
W_OBJECT_IMPL(Process::FloatKnob)
W_OBJECT_IMPL(Process::LogFloatSlider)
W_OBJECT_IMPL(Process::IntSlider)
W_OBJECT_IMPL(Process::IntRangeSlider)
W_OBJECT_IMPL(Process::FloatRangeSlider)
W_OBJECT_IMPL(Process::IntRangeSpinBox)
W_OBJECT_IMPL(Process::FloatRangeSpinBox)
W_OBJECT_IMPL(Process::IntSpinBox)
W_OBJECT_IMPL(Process::FloatSpinBox)
W_OBJECT_IMPL(Process::TimeChooser)
W_OBJECT_IMPL(Process::Toggle)
W_OBJECT_IMPL(Process::ChooserToggle)
W_OBJECT_IMPL(Process::LineEdit)
W_OBJECT_IMPL(Process::ProgramEdit)
W_OBJECT_IMPL(Process::Enum)
W_OBJECT_IMPL(Process::Button)
W_OBJECT_IMPL(Process::HSVSlider)
W_OBJECT_IMPL(Process::XYSlider)
W_OBJECT_IMPL(Process::XYZSlider)
W_OBJECT_IMPL(Process::XYSpinboxes)
W_OBJECT_IMPL(Process::XYZSpinboxes)
W_OBJECT_IMPL(Process::MultiSlider)
W_OBJECT_IMPL(Process::MultiSliderXY)
W_OBJECT_IMPL(Process::PathGeneratorXY)
W_OBJECT_IMPL(Process::Bargraph)
namespace Process
{
namespace
{
...
{
  // tryGet: these three writers are reachable through the deserializing
  // constructors, and documents older than the "Filters" key exist.
