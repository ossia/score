...
/*
    ...
    , IntervalSolidPen{QPen{QBrush{Qt::black}, 3, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin}}
    , IntervalDashPen{[] { QPen pen{
          QBrush{Qt::black}, 3, Qt::CustomDashLine, Qt::FlatCap, Qt::MiterJoin};
          pen.setDashPattern({2., 4.});
          return pen;
    }()}
    , IntervalRackPen{Qt::black, 2, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin}
    , IntervalPlayPen{IntervalSolidPen}
    , IntervalPlayDashPen{IntervalDashPen}
    , IntervalWaitingDashPen{IntervalDashPen}
    , IntervalHeaderSeparator{IntervalHeaderSideBorder,
                                   2,
                                   Qt::SolidLine,
                                   Qt::FlatCap,
                                   Qt::MiterJoin}
    , FullViewIntervalHeaderSeparator{IntervalHeaderSideBorder,
                                           2,
                                           Qt::DashLine,
                                           Qt::FlatCap,
                                           Qt::MiterJoin}

    , IntervalBrace{IntervalBase, 2, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin}

    , IntervalBraceSelected{IntervalSelected, 2, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin}
    , IntervalBraceWarning{IntervalWarning, 2, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin}
    , IntervalBraceInvalid{IntervalInvalid, 2, Qt::SolidLine, Qt::FlatCap, Qt::MiterJoin}
    , IntervalHeaderTextPen{IntervalHeaderText.color()}
...
/*
  ...
  , TimeRulerLargePen = QPen{TimeRuler, 2, Qt::SolidLine}
  , TimeRulerLargePen.setCosmetic(true)
  , TimeRulerSmallPen = QPen{TimeRuler, 1, Qt::SolidLine}
  , TimeRulerSmallPen.setCosmetic(true)

  , SlotHandlePen.setWidth(0)
  , SlotHandlePen.setBrush(ProcessViewBorder)
  ...
  , SlotHeaderTextPen.setBrush(TimenodeDefault)
  , SlotHeaderTextPen.setCosmetic(true)

  , SlotHeaderPen = QPen{IntervalHeaderSideBorder,
                       1,
                       Qt::SolidLine,
                       Qt::FlatCap,
                       Qt::MiterJoin}

  , SlotHeaderBrush = QBrush{SlotHeader}
