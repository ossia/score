...
template <>
inline void DataStreamReader::read(const Curve::EasingData& segmt)
{
}

template <>
inline void DataStreamWriter::write(Curve::EasingData& segmt)
{
}
...
// Curve::Segment_" $2 ">, \"" $1 "\", \"" $2 "\", \"" $2 "\")";}
// '

CURVE_SEGMENT_METADATA(
    , Curve::Segment_backIn, "fb5cb6c1-47fd-497c-9d69-7a87adbaf3b3", "backIn", "backIn",
    "Easing")
CURVE_SEGMENT_METADATA(
