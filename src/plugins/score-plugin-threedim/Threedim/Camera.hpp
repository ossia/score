...
public:
  ...
  // Render-thread hooks. init claims a RawCamera and a RawTransform slot;
  // update packs eye / target / up / yfov / znear / zfar into a
  // RawCameraData and uploads; release returns the slots.
