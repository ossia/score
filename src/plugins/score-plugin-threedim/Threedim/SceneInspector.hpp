...
// string patterns, and without a way to enumerate the tree the user has to
// guess. Drop this node between a loader and a filter, read the Rows list, and
// paste the path you want into the downstream node.
