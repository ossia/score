...
//     is a canonical slash-path (`/Root/Body/Wheels`), directly usable
//     in SceneGraphFilter(paths=...) / ConfigurePrimitive /
...
//
// Answers "what paths exist in this scene?": filter and selector nodes need
// string patterns, and without a way to enumerate the tree they have to be
// guessed. Placed between a loader and a filter, the Rows list gives the path
// to paste into the downstream node.
