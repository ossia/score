...
// scene_spec. Where SceneGraphFilter prunes (keeps the tree shape, drops
// non-matches), SceneSelector extracts: it gathers the matches and forgets
// the ancestors.
//
...
//                    world origin, for re-placing the extracted subtree
//                    via an upstream Transform3D / SceneGroup.
class SceneSelector
{
public:
