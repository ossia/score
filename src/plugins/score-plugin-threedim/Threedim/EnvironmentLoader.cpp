...
void EnvironmentLoader::rebuild()
{
  ...
  // standard formula is `mul = stops_gain / (K * 2^EV100)`; K=1 here so
  // that EV100 = 0, stops = 0 leaves `env.exposure = 1`, the neutral
  // value scenes saved without an EV100 setting expect.
