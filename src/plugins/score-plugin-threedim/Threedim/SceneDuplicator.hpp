...
// does GPU-primitive instancing -- one mesh, N instances, one draw call, up to
// a million particles from a single-mesh prototype. This one clones a rich
// prototype with hierarchy, multiple meshes and lights into N CPU clones, each
