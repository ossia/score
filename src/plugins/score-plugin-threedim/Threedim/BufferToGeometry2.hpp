...
#define ATTRIBUTE(i) \
        ...
        halp::lineedit<"Attr" #i " semantic", ""> semantic_ ## i; \
  ...
  struct ui
  {
    ...
    struct T
    {
      ...
      struct A1
      {
        ...
        halp::item<&ins::semantic_0> semantic;
      ...
      struct A2
      {
        ...
        halp::item<&ins::semantic_1> semantic;
      ...
      struct
      {
        ...
        halp::item<&ins::semantic_2> semantic;
      ...
      struct A3
      {
        ...
        halp::item<&ins::semantic_3> semantic;
      ...
      struct A4
      {
        ...
        halp::item<&ins::semantic_4> semantic;
      ...
      struct A5
      {
        ...
        halp::item<&ins::semantic_5> semantic;
      ...
      struct A6
      {
        ...
        halp::item<&ins::semantic_6> semantic;
      ...
      struct A7
      {
        ...
        halp::item<&ins::semantic_7> semantic;
