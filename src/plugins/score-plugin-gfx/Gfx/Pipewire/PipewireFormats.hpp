...
enum class Tag : uint8_t
{
  ...
  YUV420P,      /**< Three-plane 4:2:0, 8-bit. */
...
inline uint32_t bytesPerPixel(Tag t)
{
  switch(t)
  {
    ...
    case Tag::RGB10A2:
    case Tag::BGR10A2:
    case Tag::YUYV422:    // 16bpp packed; one "pixel" of the pair = 2 bytes
    case Tag::UYVY422:    return 4; // but we treat as 32-bit unit pairs
...
{
  // DRM_FORMAT_* are defined in <drm/drm_fourcc.h>. We hardcode the
  // tokens to avoid pulling the system header into score's public
  // surface.
  switch(t)
  {
    ...
    case Tag::P010:     return 0x30313050u; /* DRM_FORMAT_P010 */
    case Tag::P210:     return 0x30313250u; /* DRM_FORMAT_P210 */
    case Tag::NV12:     return 0x3231564eu; /* DRM_FORMAT_NV12 */
    case Tag::YUV420P:  return 0x32315559u; /* DRM_FORMAT_YUV420 */
    case Tag::YUYV422:  return 0x56595559u; /* DRM_FORMAT_YUYV */
    case Tag::UYVY422:  return 0x59565955u; /* DRM_FORMAT_UYVY */
    default:            return 0;
  }
}
