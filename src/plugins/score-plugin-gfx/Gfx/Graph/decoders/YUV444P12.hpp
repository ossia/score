...
/**
 * @brief Decodes YUV444P12 videos.
 *
 * Full chroma resolution planar YUV (4:4:4) at 12-bit depth.
 * All three planes are at full resolution, stored as 16-bit words.
 * This is the output format for ProRes 4444 XQ.
 */
struct YUV444P12Decoder : GPUVideoDecoder
{
...
void main ()
{
  ...
  explicit YUV444P12Decoder(Video::ImageFormat& d)
      : decoder{d}
  {
  }
