...
/**
 * @brief Decodes YUV444P videos.
 *
 * Full chroma resolution planar YUV (4:4:4).
 * All three planes are at full resolution.
 */
struct YUV444Decoder : GPUVideoDecoder
{
...
void main ()
{
  ...
  explicit YUV444Decoder(Video::ImageFormat& d)
      : decoder{d}
  {
  }
