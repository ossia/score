...
#define SCORE_GFX_BT601_FULL_MATRIX \
  "mat4(\n\
   ...
   -0.703749019607843,  0.531211330460634, -0.889474509803922, 1.0)\n"
...
#define SCORE_GFX_BT709_FULL_MATRIX \
  "mat4(\n\
   ...
   -0.790487843137255,  0.329009466157828, -0.931438431372549, 1.0)\n"
...
#define SCORE_GFX_SMPTE240M_FULL_MATRIX \
  "mat4(\n\
   ...
   -0.790889411764706,  0.352423152296995, -0.917082352941176, 1.0)\n"
...
#define SCORE_GFX_FCC_FULL_MATRIX \
  "mat4(\n\
   ...
   -0.702745098039216,  0.523910933865071, -0.893490196078431, 1.0)\n"
...
#define SCORE_GFX_YCGCO_FULL_MATRIX \
  "mat4(\n\
   ...
   -1.0,  1.0, -1.0, 0.0,\n\
    1.0,  0.0, -1.0, 0.0,\n\
    0.000000000000000, -0.501960784313725,  1.003921568627451, 1.0)\n"
...
#define SCORE_GFX_BT2020_FULL_MATRIX \
  "mat4(\n\
   ...
   -0.740191372549020,  0.369396080282261, -0.944389019607843, 1.0)\n"

// ============================================================
//  Convenience macros for convert_to_rgb() function generation
// ============================================================

// SMPTE 274M stores an n-bit sample as the 8-bit code scaled by 2^(n-8), so a
// sample's normalised value is code / (255 * 2^(n-8)) at every depth, and the
// neutral chroma code 128 * 2^(n-8) lands on 128/255 at every depth -- which
// is what lets one 8-bit-normalised matrix serve all of them.
//
// MSB-aligned sources (P010/P210/P410/P016/Y210/Y216) left-align the code in
// a 16-bit word, so full-scale white is 255 << 8 == 65280, never 65535:
// sampling as UNORM16 divides by 65535 and needs 65535/65280 back.
#define SCORE_GFX_MSB_ALIGNED_SCALE "1.00390625" // 65535.0 / 65280.0
