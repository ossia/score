 ...
 *
 * The decoders themselves (`HWD3D11.hpp`, `HWD3D12.hpp`, `HWCUDA.hpp`,
 * `HWVulkan.hpp`, `HWVAAPI.hpp`, `HWVideoToolbox.hpp`) do not use these
 * helpers yet.
 */
...
//
// The decoders open-code these as `(Type*)frame.data[i]` casts; using
