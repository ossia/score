...
/// by the slot's own offset and pitch. Passing the zero straight through hit
/// importExternal's planeCount guard and refused the import without ever
/// reaching EGL -- for exactly the V4L2-style producer this path exists to
/// serve, since those never fill planes[].
