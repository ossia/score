 ...
 *
 * The canonical sync primitive for capture flows that span
 ...
 *   3. cuImportExternalSemaphore on the CUDA side, through the
 *      `CudaInterop::cuda_interop_import_vulkan_semaphore` shim.
 *
