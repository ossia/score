 ...
 *
 * Replaces the ad-hoc `glFinish` + D3D11-immediate-context-flush pattern that
 * the per-backend output paths would otherwise each open-code, and gives a
 * stable hook for the Vulkan/D3D12 paths when they land.
 */
