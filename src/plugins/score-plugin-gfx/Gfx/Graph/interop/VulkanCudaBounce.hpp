 ...
 * @brief CUDA-VMM bounce buffers imported into Vulkan — the bridge between
 *        QRhi-owned resources and a vendor DMA engine.
 *
 * The GL path bridges via cuGraphicsGLRegisterBuffer + one DtoD copy
