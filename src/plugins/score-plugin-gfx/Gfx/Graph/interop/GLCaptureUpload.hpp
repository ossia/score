 ...
 *
 * Shared by the per-strategy capture headers, which otherwise carry
 * byte-for-byte identical copies of the `glTexSubImage2D` upload skeleton. The
 ...
 *
 * For the P2P path: the vendor P2P-wrote straight into the GL buffer's
