...
struct V210Encoder : GPUVideoEncoder
{
      ...
      int height, const QString& colorConversion) override
  {
    ...
    // would truncate the tail group at widths not divisible by 6 (1280,
    // 2048-DCI) and make the readback row differ from the framestore row,
    // forcing a re-stride copy; padded, they are byte-identical.
