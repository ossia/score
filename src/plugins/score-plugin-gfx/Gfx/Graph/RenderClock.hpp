 ...
 *
 * This interface wraps the two clocks score already
...
public:
  enum class Kind
  {
    ...
    ExternalGenlock  //< hardware genlock, e.g. a card's VBI
  };
...
/**
 * @brief Hardware-genlock render clock (opt-in): a card's output VBI.
 *
