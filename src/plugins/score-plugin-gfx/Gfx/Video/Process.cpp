    ...
    , m_nativeTempo{120}
{
  ...
  // VideoFileChooser gained (init, filters, name, id, parent) since this branch
  // was written; it substitutes videoFilesTypes() for whatever filters it is given.
  m_inlets.push_back(
      new Process::VideoFileChooser{path, {}, "File", Id<Process::Port>(0), this});
