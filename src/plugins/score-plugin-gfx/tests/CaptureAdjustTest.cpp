...
{
  // The whole point of the defaults: a pipeline that sets none of these
  // controls must render its input untouched.
...
TEST_CASE("render tree: the tree starts at the slot's values", "[gfx][capture]")
{
  ...
  // Stretch is the default; see CaptureAdjust::scaleMode.
