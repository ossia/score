...
int main(int argc, char** argv)
{
  ...
  // PLANE0_MODIFIER_LO/HI, even for a linear buffer, and score is the one being
  // refused; the sweep above omits them. Drivers commonly accept an
  // implicit-modifier import and reject an explicit DRM_FORMAT_MOD_LINEAR they
  // never advertised.
