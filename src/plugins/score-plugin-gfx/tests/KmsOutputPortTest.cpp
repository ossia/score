...
// scans that texture out. Without that port created, the first thing to touch
// input[0] -- connecting anything to it -- indexes an empty vector.
//
...
// shows the difference. Asserting the port directly is the cheap form of that:
