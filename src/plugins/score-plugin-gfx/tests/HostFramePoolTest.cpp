...
//
// What the readback target relies on, and nothing else checks: that each frame
// is one whole allocation with no interior offset, that it is aligned to the granule the GPU wrap needs, that an
