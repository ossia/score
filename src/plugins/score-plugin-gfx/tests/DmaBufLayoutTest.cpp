...
// Refusing on the driver id alone would also refuse GBM and NvBufSurface
// buffers, which measure 10/10 byte-exact on the same driver. What decides it
// is who allocated the buffer.
