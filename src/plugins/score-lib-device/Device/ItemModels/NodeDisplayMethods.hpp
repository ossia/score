...
SCORE_LIB_DEVICE_EXPORT QVariant
GetColumnData(const Device::Node& node, int role);
SCORE_LIB_DEVICE_EXPORT QVariant
SetColumnData(const Device::Node& node, int role);
SCORE_LIB_DEVICE_EXPORT QVariant
minColumnData(const Device::Node& node, int role);
SCORE_LIB_DEVICE_EXPORT QVariant
maxColumnData(const Device::Node& node, int role);
}
