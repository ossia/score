...
SCORE_DECLARE_ACTION(OpenSettings, "&Settings", Common, QKeySequence::Preferences)
SCORE_DECLARE_ACTION(OpenProjectSettings, "&Project Settings", Common, QKeySequence::UnknownKey)

SCORE_DECLARE_ACTION(RestoreLayout, "&Restore Layout", Common, QKeySequence::UnknownKey)
