...
public:
  ...
  void fileNameChanged(QString fileName) E_SIGNAL(
      SCORE_LIB_BASE_EXPORT,
      fileNameChanged,
      fileName) void authorChanged(QString author)
      E_SIGNAL(
          SCORE_LIB_BASE_EXPORT,
          authorChanged,
          author) void creationChanged(QDateTime creation)
          E_SIGNAL(
              SCORE_LIB_BASE_EXPORT,
              creationChanged,
              creation) void lastEditionChanged(QDateTime lastEdition)
              E_SIGNAL(SCORE_LIB_BASE_EXPORT, lastEditionChanged, lastEdition)
                  ...
                  W_PROPERTY(
                      ...
                      W_PROPERTY(
                          QString,
                          author READ author WRITE setAuthor NOTIFY
                              authorChanged,
                          W_Final)
                          W_PROPERTY(
                              QDateTime,
                              ...
                              W_PROPERTY(
                                  QDateTime,
                                  lastEdition READ lastEdition WRITE
                                      setLastEdition NOTIFY lastEditionChanged,
                                  W_Final)
};
}
