...
PAIRS = [
    ...
    ("texture cable",        "Cable4",     "Background1", "thin"),
    ("geometry cable",       "Cable5",     "Background1", "thin"),
...
GROUPS = [
    ("port types",      ["Port1", "Port2", "Port3", "Port4", "Port5"], 12.0),
    ("cable types",     ["Cable1", "Cable2", "Cable3", "Cable4", "Cable5"], 12.0),
...
SEMANTIC_HUE = {
    ...
    "Cable1", "Cable2", "Cable3", "Cable4", "Cable5",
    "SelectedCable1", "SelectedCable2", "SelectedCable3",
    "SelectedCable4", "SelectedCable5",
    "Base1", "Base2", "Base3",
    "Emphasis3",
}
