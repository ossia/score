...
class MatchedCurveTransition
    : public GenericTransition<iscore::MatchedTransition<Event>>
{
public:
...
{
public:
  using MatchedCurveTransition<CurveEvent<Element_T, Modifier_T>>::
      MatchedCurveTransition;
...
private:
  ...
  void
  impl(CurveEvent<Element::Nothing_tag, iscore::Modifier::Release_tag>* ev)
  {
  }
  ...
  void
  impl(CurveEvent<Element::Segment_tag, iscore::Modifier::Release_tag>* ev)
  {
    this->state().hoveredSegmentId
        = safe_cast<const SegmentView*>(ev->item)->model().id();
  }
...
using ClickOnNothing_Transition
    = PositionedCurveTransition<Element::Nothing_tag, iscore::Modifier::Click_tag>;
using ClickOnPoint_Transition
    = PositionedCurveTransition<Element::Point_tag, iscore::Modifier::Click_tag>;
using ClickOnSegment_Transition
    = PositionedCurveTransition<Element::Segment_tag, iscore::Modifier::Click_tag>;

using MoveOnNothing_Transition
    = PositionedCurveTransition<Element::Nothing_tag, iscore::Modifier::Move_tag>;
using MoveOnPoint_Transition
    = PositionedCurveTransition<Element::Point_tag, iscore::Modifier::Move_tag>;
using MoveOnSegment_Transition
    = PositionedCurveTransition<Element::Segment_tag, iscore::Modifier::Move_tag>;

using ReleaseOnNothing_Transition
    = PositionedCurveTransition<Element::Nothing_tag, iscore::Modifier::Release_tag>;
using ReleaseOnPoint_Transition
    = PositionedCurveTransition<Element::Point_tag, iscore::Modifier::Release_tag>;
using ReleaseOnSegment_Transition
    = PositionedCurveTransition<Element::Segment_tag, iscore::Modifier::Release_tag>;
