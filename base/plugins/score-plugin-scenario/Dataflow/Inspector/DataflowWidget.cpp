  ...
  , m_lay{this}
{
  ...
  con(proc, &Process::ProcessModel::inletsChanged, this, &DataflowWidget::reinit, Qt::QueuedConnection);
  con(proc, &Process::ProcessModel::outletsChanged, this, &DataflowWidget::reinit, Qt::QueuedConnection);
...
QWidget*CableInspectorFactory::make(
  ...
  return new CableWidget{
    safe_cast<const Process::Cable&>(*sourceElements.first()), doc,
        parent};
}
