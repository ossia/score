...
void Node::cleanup()
{
  auto& p = score::IDocument::documentContext(*this).model<Scenario::ScenarioDocumentModel>();
  ...
  , process{proc}
{
  ...
  auto& doc = score::IDocument::documentContext(proc);
...
/*
template<>
SCORE_LIB_PROCESS_EXPORT void DataStreamReader::read<Process::DataflowProcess>(const Process::DataflowProcess& p)
{
  m_stream << p.cables << p.m_inlets << p.m_outlets;
}
template<>
SCORE_LIB_PROCESS_EXPORT void DataStreamWriter::write<Process::DataflowProcess>(Process::DataflowProcess& p)
{
  m_stream >> p.cables >> p.m_inlets >> p.m_outlets;
}

template<>
SCORE_LIB_PROCESS_EXPORT void JSONObjectReader::read<Process::DataflowProcess>(const Process::DataflowProcess& p)
{
...
template<>
SCORE_LIB_PROCESS_EXPORT void JSONObjectWriter::write<Process::DataflowProcess>(Process::DataflowProcess& p)
{
