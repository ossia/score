	...
	namespace Command
	{
		...
		class AggregateCommand : public iscore::SerializableCommand
		{
			public:
				...
				template<typename T>
				AggregateCommand(QString parname, QString cmdname, QString text, const T& cmd):
				...
				AggregateCommand(QString parname, QString cmdname, QString text, const T& cmd, Args&&... remaining):
