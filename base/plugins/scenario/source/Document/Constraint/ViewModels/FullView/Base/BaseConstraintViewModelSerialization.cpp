...
template<>
void Visitor<Reader<DataStream>>::readFrom(const BaseConstraintViewModel& constraint)
{
	readFrom(static_cast<const AbstractConstraintViewModel&>(constraint));
}

template<>
void Visitor<Reader<JSON>>::readFrom(const BaseConstraintViewModel& constraint)
{
	readFrom(static_cast<const AbstractConstraintViewModel&>(constraint));
}
