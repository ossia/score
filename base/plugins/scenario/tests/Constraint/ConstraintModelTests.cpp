...
class ConstraintModelTests: public QObject
{
	...
	private slots:
		...
		void FindSubProcessTest()
		{
			...
			s0->createConstraintAndEndEventFromEvent(s0->startEvent()->id(), 34, 10, int_0_id, fv_0_id, ev_0_id, tb_0_id);
			...
			s0->createConstraintAndEndEventFromEvent(s0->startEvent()->id(), 46, 10, int_2_id, fv_2_id, ev_2_id, tb_2_id);
