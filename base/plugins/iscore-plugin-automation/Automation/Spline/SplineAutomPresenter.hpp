...
namespace Spline
{
class ChangeSpline final : public iscore::Command
{
    ISCORE_COMMAND_DECL(Automation::CommandFactoryName(), ChangeSpline, "ChangeSpline")
    public:
      ChangeSpline(
        const ProcessModel& autom, const spline_data& newval)
    : m_path{autom}
    , m_old{autom.spline()}
    , m_new{newval}
{
