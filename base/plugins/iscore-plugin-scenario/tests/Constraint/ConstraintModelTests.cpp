...
private slots:
  ...
  void CreateSlotTest()
  {
    ConstraintModel model{Id<ConstraintModel>{0}, Id<ConstraintViewModel>{0},
                          this};
  ...
  {
    ConstraintModel i0{Id<ConstraintModel>{0}, Id<ConstraintViewModel>{0},
                       qApp};
    ...
    ObjectPath p{{"OriginalConstraint", {0}},
                 {"ScenarioModel", 0},
                 {"ConstraintModel", int_0_id},
                 {"ScenarioModel", 1}};
    QCOMPARE(p.find<QObject>(), s2);

    ObjectPath p2{{"OriginalConstraint", {0}},
                  {"ScenarioModel", 0},
                  {"ConstraintModel", int_0_id},
                  {"ScenarioModel", 7}};
    ...
    ObjectPath p3{{"OriginalConstraint", {0}},
                  {"ScenarioModel", 0},
    ...
    ObjectPath p4{{"OriginalConstraint", {0}},
                  {"ScenarioModel", 0},
                  {"ConstraintModel", int_0_id},
                  {"ScenarioModel", 1},
                  {"ScenarioModel", 1}};
