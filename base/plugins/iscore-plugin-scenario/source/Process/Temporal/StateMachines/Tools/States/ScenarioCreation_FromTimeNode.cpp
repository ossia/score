...
void ScenarioCreation_FromTimeNode::createSingleEventAndState()
{
    ISCORE_TODO
            /*
            auto cmd =
...
void ScenarioCreation_FromTimeNode::createToNothing(const ScenarioStateMachine &stateMachine)
{
    ISCORE_TODO
            /*
