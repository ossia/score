...
void CreateInterval_State_Event_TimeSync::undo(const iscore::DocumentContext& ctx) const
{
  m_command.undo(ctx);
...
void CreateInterval_State_Event_TimeSync::redo(const iscore::DocumentContext& ctx) const
{
