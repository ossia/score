...
void CreateInterval_State_Event::undo(const iscore::DocumentContext& ctx) const
{
  m_command.undo(ctx);
...
void CreateInterval_State_Event::redo(const iscore::DocumentContext& ctx) const
{
