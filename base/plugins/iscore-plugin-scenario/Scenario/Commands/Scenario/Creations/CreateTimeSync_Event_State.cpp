...
void CreateTimeSync_Event_State::undo(const iscore::DocumentContext& ctx) const
{
  m_command.undo(ctx);
...
void CreateTimeSync_Event_State::redo(const iscore::DocumentContext& ctx) const
{
