...
{
        ISCORE_COMMAND_DECL(ScenarioCommandFactoryName(), GenericInterpolateMacro, "GenericInterpolateMacro")
};

class InterpolateMacro final : public iscore::AggregateCommand
{
        ISCORE_COMMAND_DECL(ScenarioCommandFactoryName(), InterpolateMacro, "InterpolateMacro")
