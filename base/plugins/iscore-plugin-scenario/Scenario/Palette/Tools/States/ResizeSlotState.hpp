...
class ResizeSlotState final : public SlotState
{
    public:
            ...
            m_sm{sm}
        {
            ...
            iscore::make_transition<Scenario::MoveOnAnything_SlotTransition>(press, move);
            iscore::make_transition<Scenario::MoveOnAnything_SlotTransition>(move, move);
            iscore::make_transition<Scenario::ReleaseOnAnything_SlotTransition>(press, release);
            iscore::make_transition<Scenario::ReleaseOnAnything_SlotTransition>(move, release);
