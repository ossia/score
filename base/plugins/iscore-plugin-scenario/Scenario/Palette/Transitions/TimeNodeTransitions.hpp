...
{
public:
  using MatchedTransition<Scenario_T, ClickOnTimeNode_Event>::
      MatchedTransition;
...
protected:
  ...
  {
    if (e->type()
        == QEvent::Type(QEvent::User + ClickOnTimeNode_Event::user_type))
    {
...
{
public:
  using MatchedTransition<Scenario_T, ReleaseOnTimeNode_Event>::
      MatchedTransition;
...
template <typename Scenario_T>
using ReleaseOnTimeNode_Transition
    = Transition_T<Scenario_T, ReleaseOnTimeNode>;
}
