...
{
public:
  using MatchedTransition<Scenario_T, ClickOnConstraint_Event>::
      MatchedTransition;
...
template <typename Scenario_T>
using ClickOnConstraint_Transition
    = Transition_T<Scenario_T, ClickOnConstraint>;
...
{
public:
  using MatchedTransition<Scenario_T, MoveOnConstraint_Event>::
      MatchedTransition;
