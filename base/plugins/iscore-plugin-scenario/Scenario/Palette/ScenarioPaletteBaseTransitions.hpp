...
class MatchedTransition : public iscore::StateAwareTransition<Scenario::StateBase<Scenario_T>, iscore::MatchedTransition<Event_T>>
{
    public:
        using iscore::StateAwareTransition<Scenario::StateBase<Scenario_T>, iscore::MatchedTransition<Event_T>>::StateAwareTransition;
};
