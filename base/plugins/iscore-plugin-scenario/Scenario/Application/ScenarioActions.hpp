...
ISCORE_DECLARE_SELECTED_OBJECT_CONDITION(Scenario::IntervalModel)
...
ISCORE_DECLARE_ACTION(LockMode, "&Lock", Scenario, QKeySequence{QObject::tr("Alt")})
...
ISCORE_PROCESS_DECLARE_CONTEXT_MENU(
    ISCORE_PLUGIN_SCENARIO_EXPORT, IntervalContextMenu)
ISCORE_PROCESS_DECLARE_CONTEXT_MENU(
