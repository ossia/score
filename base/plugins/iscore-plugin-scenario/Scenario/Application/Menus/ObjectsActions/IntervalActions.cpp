...
void IntervalActions::makeGUIElements(iscore::GUIElements& ref)
{
  ...
  object.menu()->addAction(m_hideRacks);
  {
    ...
    ref.toolbars.emplace_back(
          bar, StringKey<iscore::Toolbar>("Interval"), 0, 0);
  }
...
void IntervalActions::setupContextMenu(
