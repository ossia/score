...
template<>
class ScenarioTransition_T<ScenarioElement::Event + Modifier::Click_tag::value> final :
...
template<>
class ScenarioTransition_T<ScenarioElement::Event + Modifier::Move_tag::value> final :
...
template<>
class ScenarioTransition_T<ScenarioElement::Event + Modifier::Release_tag::value> final :
