...
// Contains a single rack which can contain multiple slots and a Add Slot
// button.
class SlotInspectorSection final : public Inspector::InspectorSectionWidget,
...
public:
  ...
  void createLayerModel(const Id<Process::ProcessModel>& sharedProcessId);
...
private:
  ...
  iscore::
      CommandSpinbox<SlotModelHeightParameter, Command::ResizeSlotVertically, QSpinBox>
          m_sb;
};
}
