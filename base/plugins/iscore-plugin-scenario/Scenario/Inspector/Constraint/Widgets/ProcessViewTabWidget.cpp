...
void ProcessViewTabWidget::activeRackChanged(
    OptionalId<RackModel> rack, ConstraintViewModel* vm)
{
  // TODO mettre à jour l'inspecteur si la rack affichée change (i.e. via une
  // commande réseau).
...
{
  // Display the widget
  auto newRack = new RackInspectorSection{rack.metadata().getName(), rack,
                                          m_constraintWidget, this};
