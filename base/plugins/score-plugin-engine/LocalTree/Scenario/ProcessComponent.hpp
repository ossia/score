...
class SCORE_PLUGIN_ENGINE_EXPORT ProcessComponentFactory
    : public score::GenericComponentFactory<
          Process::ProcessModel, LocalTree::DocumentPlugin,
...
public:
  ...
  virtual ProcessComponent* make(
      const Id<score::Component>&, ossia::net::node_base& parent,
      Process::ProcessModel& proc, LocalTree::DocumentPlugin& doc,
