...
void OSSIADevice::renameListening_impl(
    ...
    const ossia::net::node_base& node, std::string old_name)
{
  ...
  Device::AddressSettings as = Engine::ossia_to_score::ToAddressSettings(node);
