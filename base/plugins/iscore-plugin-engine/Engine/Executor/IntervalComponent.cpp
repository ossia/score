...
IntervalComponentBase::IntervalComponentBase(
    ...
    QObject* parent)
    : Scenario::GenericIntervalComponent<const Context>{iscore_cst, ctx, id, "Executor::Interval", nullptr}
{
...
Scenario::IntervalModel& IntervalComponentBase::iscoreInterval() const
{
  return interval();
}
