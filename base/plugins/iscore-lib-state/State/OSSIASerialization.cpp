...
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Reader<JSONValue>>::readFrom(const ossia::value& n);
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Writer<JSONValue>>::writeTo(ossia::value& n);
...
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Reader<JSONObject>>::readFrom(const ossia::net::domain& n)
{
    readFrom((const ossia::net::domain_base_variant&) n);
}

template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Writer<JSONObject>>::writeTo(ossia::net::domain& n)
{
    writeTo((ossia::net::domain_base_variant&) n);
}
...
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Reader<JSONValue>>::readFrom(const ossia::Impulse& n)
{
}

template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Writer<JSONValue>>::writeTo(ossia::Impulse& n)
{
}

template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Reader<JSONValue>>::readFrom(const std::array<float, 2>& n)
{
    val = toJsonValue(n);
}
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Reader<JSONValue>>::readFrom(const std::array<float, 3>& n)
{
    val = toJsonValue(n);
}
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Reader<JSONValue>>::readFrom(const std::array<float, 4>& n)
{
    val = toJsonValue(n);
}

template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Writer<JSONValue>>::writeTo(std::array<float, 2>& n)
{
    fromJsonValue(val, n);
}
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Writer<JSONValue>>::writeTo(std::array<float, 3>& n)
{
    fromJsonValue(val, n);
}
template<>
ISCORE_LIB_STATE_EXPORT void Visitor<Writer<JSONValue>>::writeTo(std::array<float, 4>& n)
{
    fromJsonValue(val, n);
}
