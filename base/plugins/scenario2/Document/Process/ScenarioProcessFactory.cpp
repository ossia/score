...
iscore::ProcessSharedModelInterface*ScenarioProcessFactory::makeModel(unsigned int id, QByteArray data, QObject* parent)
{
	return new ScenarioProcessSharedModel(id, data, parent);
}