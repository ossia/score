 ...
 */
class SCORE_LIB_PROCESS_EXPORT AutomatableFactory
...
public:
  ...
  virtual bool matches(
      const ossia::complex_type& t) const noexcept = 0;

  //! Get the factory used
  virtual Process::ProcessModelFactory* get(
      const score::ApplicationContext& ctx) const noexcept = 0;
...
{
  Process::ProcessModelFactory* get(
