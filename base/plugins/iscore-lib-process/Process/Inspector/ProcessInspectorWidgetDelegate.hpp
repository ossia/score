...
class StateProcess;
class ISCORE_LIB_PROCESS_EXPORT StateProcessInspectorWidgetDelegate
    : public QWidget
{
public:
  using QWidget::QWidget;
...
template <typename Process_T>
class StateProcessInspectorWidgetDelegate_T
    : public StateProcessInspectorWidgetDelegate
{
public:
  StateProcessInspectorWidgetDelegate_T(
      const Process_T& process, QWidget* parent)
      : StateProcessInspectorWidgetDelegate{parent}, m_process{process}
  {
  }
