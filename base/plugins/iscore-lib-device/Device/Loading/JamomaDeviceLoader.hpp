...
{
/**
 * @brief loadDeviceFromJamomaJSON Will load a device in a Jamoma-format XML file into the node.
 *
...
/**
 * @brief loadDeviceFromJamomaJSON Will load a device in a Jamoma-format JSON file into the node.
 *
 * The node has to be the device node.
 */
ISCORE_LIB_DEVICE_EXPORT bool
