...
bool VSTControlPortItem::on_createAutomation(Scenario::IntervalModel& cst, std::function<void (score::Command*)> macro, const score::DocumentContext& ctx)
{
...
Dataflow::PortItem*
VSTControlPortFactory::makeItem(
    Process::Inlet& port
