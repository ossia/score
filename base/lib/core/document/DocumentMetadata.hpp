...
public:
  ...
  void fileNameChanged(QString fileName) W_SIGNAL(
      fileNameChanged, fileName) void authorChanged(QString author)
      W_SIGNAL(authorChanged, author) void creationChanged(QDateTime creation)
          W_SIGNAL(creationChanged, creation) void lastEditionChanged(
              QDateTime lastEdition) W_SIGNAL(lastEditionChanged, lastEdition)
