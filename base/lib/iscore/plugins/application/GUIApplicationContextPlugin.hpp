...
namespace iscore
{
     ...
     *
     * It is instatiated exactly once and is accessible via the application context,
     ...
     * - The SerializableDocumentPlugin are loaded (see iscore::DocumentPluginFactory)
     * - on_loadedDocument is called for all plug-ins.
     *
     * Finally, on_createdDocument is called for all plug-ins.
     * If the document becomes visible, on_documentChanged is called for all plug-ins.
     *
     */
