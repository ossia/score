...
template <typename Model_T, typename MakeTuple> class GenericComponentFactory_Make;
...
class GenericComponentFactoryImpl : public ComponentFactoryBase_T
{
        ...
        using ConcreteFactoryKey = typename ComponentFactoryBase_T::ConcreteFactoryKey;
