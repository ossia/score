...
class GenericMacroCommandDispatcher final : public ICommandDispatcher
{
    public:
        ...
        {
            static_assert(std::is_base_of<iscore::AggregateCommand, Command_T>::value,
...
using MacroCommandDispatcher = GenericMacroCommandDispatcher<Command_T, RedoStrategy::Quiet, SendStrategy::Simple>;

// Redo the individual commands, don't redo the aggregate command
template<typename Command_T>
using RedoMacroCommandDispatcher = GenericMacroCommandDispatcher<Command_T, RedoStrategy::Redo, SendStrategy::Quiet>;

// Don't redo anything, just push
template<typename Command_T>
using QuietMacroCommandDispatcher = GenericMacroCommandDispatcher<Command_T, RedoStrategy::Quiet, SendStrategy::Quiet>;
