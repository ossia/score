...
wget -nv https://github.com/ossia/sdk/releases/download/sdk27/$SDK_ARCHIVE -O $SDK_ARCHIVE

wget -nv https://github.com/ossia/sdk/releases/download/sdk25/icu71.tar.gz -O icu71.tar.gz
